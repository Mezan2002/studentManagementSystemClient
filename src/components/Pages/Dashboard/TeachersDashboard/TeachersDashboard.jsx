...
import TeachersDashboardLeft from "./TeachersDashboardLeft/TeachersDashboardLeft";

const TeachersDashboard = ({usersName,usersType,usersImage}) => {
  return (
    <section>
    <div className="grid grid-cols-12">
      <div className="col-span-2 bg-[#E8F0FD] min-h-screen text-center relative">
        <TeachersDashboardLeft usersImage={usersImage} usersName={usersName} usersType={usersType}></TeachersDashboardLeft>
      </div> 
