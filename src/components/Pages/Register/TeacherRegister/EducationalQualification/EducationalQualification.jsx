    ...
    <section>
      <div
        className={`${
          ...
          "border border-red-400 mt-5 p-5 rounded-lg"
        }`}
      >
        ...
        <div
          className={`${
            educationalQualification.length !== 0 &&
            "border-b border-gray-500 pb-4 border-dashed mb-5"
          } `}
        >
      ...
      {educationalQualification.length === 0 && (
        <p className="ml-1 mt-2 text-red-400 text-sm font-semibold">
          Sir, please add at least 1 educational qualification
        </p>
      )}
    </section>
  );
